...
def plot_model(ax, woehler_points, woehler_params, label_1 = '', color_1 = 'navy'):
    '''
    PLots the woehler model lines (P_a = 10%, 50% and 90%) with k_2 = infinity. The woehler points are used to set the axes.
...
def plot_model_2(ax, woehler_points, woehler_params, label_1 = '', color_1 = 'navy'):
    '''
    PLots the woehler model lines (P_a = 10%, 50% and 90%) for a model with k_2 specified. The woehler points are used to set the axes.
    ...
    if one_t_s  != None and s_d_50 != None:
        ...
        n_s_d_50_2      = np.linspace(n_e, n_max, 10000)
        amp_s_d_50_2    = 10 ** (-1*((np.log10(n_s_d_50_2)-np.log10(n_max))/k_2-np.log10(s_d_50)))
        n_s_d_50_1      = np.linspace(n.min(), n_e, 10000)
        amp_s_d_50_1    =  10 ** (-1*((np.log10(n_s_d_50_1)-np.log10(n_e))/k-np.log10(max(amp_s_d_50_2))))
        
      
        amp_s_d_10_2    = 10 ** (-1*((np.log10(n_s_d_50_2)-np.log10(n_max))/k_2-np.log10(s_d_10)))# - (s_d_50 - s_d_10)
        amp_s_d_10_1    = 10 ** (-1*((np.log10(n_s_d_50_1)-np.log10(n_e))/k-np.log10(max(amp_s_d_10_2))))
        
        amp_s_d_90_2    = 10 ** (-1*((np.log10(n_s_d_50_2)-np.log10(n_max))/k_2-np.log10(s_d_90)))# - (s_d_50 - s_d_10)
        amp_s_d_90_1    = 10 ** (-1*((np.log10(n_s_d_50_1)-np.log10(n_e))/k-np.log10(max(amp_s_d_90_2))))
        
        
        plt.loglog(n_s_d_50_1,amp_s_d_50_1,linewidth=3,color= color_1, label = label_1 + ' $N_{50\%}$')
        plt.loglog(n_s_d_50_2,amp_s_d_50_2,linewidth=3,color= color_1)
        
        plt.loglog(n_s_d_50_1,amp_s_d_10_1,linewidth=3,color= color_1, linestyle='dashed', label = label_1 + ' $N_{10\%}$ u. $N_{90\%}$')
        plt.loglog(n_s_d_50_2,amp_s_d_10_2,linewidth=3,color= color_1, linestyle='dashed')
        
        plt.loglog(n_s_d_50_1,amp_s_d_90_1,linewidth=3,color= color_1, linestyle='dashed')
        plt.loglog(n_s_d_50_2,amp_s_d_90_2,linewidth=3,color= color_1, linestyle='dashed')
        ax.legend()
...
def plot_normal(ax, mu, sd, color_1 = 'red', label_1 = 'Prior'):
    '''
