...
class DOE:
    ...
    def generate_load_levels(self, woehler_params):
        '''
        This function generates 4 viable load levels on the basis of esitimated or known woehler parameters. One for a runout probability of 0.7 one for P_r =0.3.
